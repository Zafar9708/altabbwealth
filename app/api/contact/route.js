...
//     // Send JSON format to Web3Forms (most stable)
...
//       },
//       body: JSON.stringify({
//         access_key: "350dd7d0-1358-4331-a25c-d584f3457b01",
//         from_name: "Altabb Wealth Website",
//         subject: `New Consultation Request from ${name}`,
//         replyto: email,
//         name,
//         email,
...
//     if (!result.success) {
//       return NextResponse.json(
//         { success: false, error: result.message || "Web3Forms failed" },
//         { status: 500 }
//       );
//     }
