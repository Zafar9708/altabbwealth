...
const GetStartedPage = () => {
    ...
    return (
        <div className="min-h-screen bg-[#8BC53F] pt-20">
            {/* Success Message */}
            {showSuccess && (
            ...
            <div className="bg-white py-16">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="flex justify-center mb-6">
                        <div className="w-24 h-24 bg-[#8BC53F] rounded-full flex items-center justify-center border-4 border-[#8BC53F]">
                            <img
                                src="/Logo.png"
                                alt="cmdfin Logo"
            ...
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-white rounded-2xl shadow-2xl border border-yellow-200 overflow-hidden">
                    <div className="bg-[#8BC53F] py-6 px-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
                    <div className="text-center p-6 bg-white rounded-xl shadow-lg border border-yellow-100">
                        <div className="w-12 h-12 bg-[#8BC53F] rounded-full flex items-center justify-center mx-auto mb-4">
