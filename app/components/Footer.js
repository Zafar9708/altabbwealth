...
const Footer = () => {
  ...
  const services = [
    { name: "Finance", path: "/services/accounting" },
    { name: "CFO Advisory Services", path: "/services/cfo-advisory" },
    { name: "Business Tax Services", path: "/services/tax-services" },
    { name: "Financial Planning & Analysis", path: "/services/financial-planning" },
    { name: "Mergers & Acquisitions", path: "/services/mergers-acquisitions" },
    { name: "Comprehensive Audit and Legal Oversight", path: "/services/audit-legal" }
  ];
            ...
            <div className="lg:col-span-2">
              ...
              <div className="mb-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <a href="#" className="w-10 h-10 bg-brand-gold/20 rounded-lg flex items-center justify-center hover:bg-brand-gold transition-colors duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 5.079 3.158 9.417 7.618 11.174-.105-.949-.199-2.403.042-3.441.219-.937 1.407-5.965 1.407-5.965s-.359-.719-.359-1.782c0-1.668.967-2.914 2.171-2.914 1.023 0 1.518.769 1.518 1.69 0 1.029-.653 2.567-.992 3.992-.285 1.193.6 2.165 1.775 2.165 2.128 0 3.768-2.245 3.768-5.487 0-2.861-2.063-4.869-5.008-4.869-3.41 0-5.409 2.562-5.409 5.199 0 1.033.394 2.143.889 2.741.099.12.112.225.085.345-.90.375-.293 1.199-.334 1.363-.053.225-.172.271-.402.165-1.495-.69-2.433-2.878-2.433-4.646 0-3.776 2.748-7.252 7.92-7.252 4.158 0 7.392 2.967 7.392 6.923 0 4.135-2.607 7.462-6.233 7.462-1.214 0-2.357-.629-2.75-1.378l-.748 2.853c-.271 1.043-1.002 2.35-1.492 3.146C9.57 23.812 10.763 24.009 12.017 24.009c6.624 0 11.99-5.367 11.99-11.988C24.007 5.367 18.641.001.012.017z"/>
                    </svg>
                  </a>
                  <a href="#" className="w-10 h-10 bg-brand-gold/20 rounded-lg flex items-center justify-center hover:bg-brand-gold transition-colors duration-300">
                    <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <ul className="space-y-3">
                {services.map((service, index) => (
                  <li key={index}>
                    <Link href={service.path} className="text-white/70 hover:text-brand-gold transition-colors duration-300 text-sm">
                      {service.name}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-3">
                {company.map((item, index) => (
                  <li key={index}>
                    <Link href={item.path} className="text-white/70 hover:text-brand-gold transition-colors duration-300 text-sm">
                      {item.name}
                    </Link>
                  </li>
                ))}
