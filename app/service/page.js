          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <select
                ...
                onChange={handleInputChange}
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-[#8BC53F] focus:ring-2 focus:ring-[#8BC53F]/20 transition-colors duration-300 bg-white"
              >
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {categories.map((category) => (
              <button
                ...
                style={{ 
                  backgroundColor: activeCategory === category.id ? '#8BC53F' : undefined,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {currentService.services.map((service, index) => (
              ...
              >
                <div className="p-8">
                  {/* Service Icon */}
                  <div className="text-4xl mb-4" style={{ color: '#8BC53F' }}>
                    {service.icon}
                  </div>
