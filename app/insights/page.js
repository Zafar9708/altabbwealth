...
//   const insightsData = [
//     { id: 1, category: 'Tax Strategy', title: 'Q4 Tax Planning: Key Deductions for High-Net-Worth Individuals', date: 'October 15, 2024', author: 'Marcus Altmann', link: '#', image: 'https://placehold.co/800x400/1C315B/C6A04A?text=FEATURED+TAX', isFeatured: true },
//     { id: 2, category: 'CFO Advisory', title: 'Implementing AI in Financial Modeling: An Operational Imperative', date: 'September 28, 2024', author: 'Sara Tabib', link: '#', image: 'https://placehold.co/400x250/FAF1E6/14274E?text=CFO+ADVISORY' },
//     { id: 3, category: 'Wealth Planning', title: 'The 2025 Market Outlook: Navigating Volatility and Opportunities', date: 'September 1, 2024', author: 'Dr. John Bannister', link: '#', image: 'https://placehold.co/400x250/FAF1E6/14274E?text=MARKET+OUTLOOK' },
//     { id: 4, category: 'Tax Strategy', title: 'Estate Tax Law Changes: What You Need to Know for Legacy Structuring', date: 'August 10, 2024', author: 'Marcus Altmann', link: '#', image: 'https://placehold.co/400x250/FAF1E6/14274E?text=LEGACY+LAW' },
//     { id: 5, category: 'CFO Advisory', title: 'Optimizing Cash Flow: Strategic Financial Health for Mid-Market Firms', date: 'July 25, 2024', author: 'Sara Tabib', link: '#', image: 'https://placehold.co/400x250/FAF1E6/14274E?text=CASH+FLOW' },
//     { id: 6, category: 'Wealth Planning', title: 'ESG Investing: Aligning Capital with Value and Ethics', date: 'July 1, 2024', author: 'Dr. John Bannister', link: '#', image: 'https://placehold.co/400x250/FAF1E6/14274E?text=ESG+INVESTING' },
//   ];

//   const categories = ['All', 'Tax Strategy', 'CFO Advisory', 'Wealth Planning', 'Market Analysis'];
...
//       {/* Hero Section */}
//       <section className="pt-32 pb-20 bg-[#14274E]">
...
//               Strategic Clarity in a <span className="text-[#C6A04A]">Complex Market</span>
//             </h1>
//             <p className="text-xl text-white/80 max-w-3xl leading-relaxed">
//               Our curated research and analysis provides a proactive perspective on global finance, 
...
//           {/* Featured Insight */}
//           {featuredInsight && (
//             <div className="bg-white rounded-2xl shadow-2xl overflow-hidden mb-16 border border-[#C6A04A]/20">
//               <div className="grid grid-cols-1 lg:grid-cols-3">
//                 <div className="col-span-1 h-64 lg:h-96">
//                   <img 
...
//                   />
//                 </div>
//                 <div className="col-span-2 p-8 lg:p-12 flex flex-col justify-center">
//                   <span className="text-sm font-bold uppercase tracking-widest mb-3 text-[#C6A04A]">
//                     Featured Analysis
//                   </span>
//                   <h2 className="text-3xl md:text-4xl font-bold text-[#14274E] mb-6 leading-tight">
//                     {featuredInsight.title}
//                   </h2>
//                   <p className="text-[#14274E]/70 text-lg mb-6 leading-relaxed">
//                     A deeper dive into the most critical financial topic this quarter, analyzed by our leading expert, {featuredInsight.author}. This is our must-read strategic report.
//                   </p>
//                   <p className="text-[#14274E] font-semibold">
//                     Published: {featuredInsight.date}
//                   </p>
//                 </div>
//               </div>
//             </div>
...
//               Explore Our <span className="text-[#C6A04A]">Publications</span>
//             </h2>
//             <p className="text-xl text-[#14274E]/70 max-w-3xl mx-auto">
//               Latest insights and strategic analysis from our expert team
//             </p>
//           </div>
...
//               <div className="bg-white rounded-2xl p-6 shadow-lg border border-[#C6A04A]/10 sticky top-8">
//                 <h3 className="text-lg font-bold text-[#14274E] mb-6">Filter by Topic</h3>
...
//                 {/* Search */}
//                 <div>
//                   <h3 className="text-lg font-bold text-[#14274E] mb-4">Search Insights</h3>
//                   <input
//                     type="text"
//                     placeholder="E.g., M&A, Legacy, AI..."
//                     value={searchTerm}
...
//                     <div 
//                       key={insight.id}
//                       className="bg-white rounded-2xl shadow-lg border border-[#C6A04A]/10 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-1 h-full flex flex-col"
//                     >
//                       <img 
//                         src={insight.image} 
//                         alt={insight.title} 
...
//                         <span className="text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full bg-[#FAF1E6] text-[#14274E] inline-block w-fit mb-4">
//                           {insight.category}
//                         </span>
//                         <h3 className="text-xl font-bold text-[#14274E] mb-3 leading-tight flex-1">
//                           {insight.title}
//                         </h3>
//                         <div className="mt-auto pt-4 border-t border-[#C6A04A]/10">
//                           <p className="text-[#14274E]/70 text-sm">
...
//                 </div>
//               ) : (
//                 <div className="text-center py-16 border-2 border-dashed border-[#C6A04A]/30 rounded-2xl bg-white">
//                   <p className="text-xl text-[#14274E]/70">
//                     No publications found matching your current filters.
//                   </p>
//                 </div>
//               )}
//             </div>
...
//       {/* CTA Section */}
//       <section className="py-20 bg-[#14274E]">
//         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
//           <h2 className="text-4xl font-bold text-white mb-6">
//             Need Direct Advice on a Topic?
//           </h2>
//           <p className="text-xl text-white/80 mb-8 max-w-2xl mx-auto">
//             Reach out to our advisory team for a personalized discussion on your strategic needs.
//           </p>
//           <a
//             href="/contact"
//             className="bg-[#C6A04A] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#C6A04A]/90 transition-colors duration-300 inline-block"
//           >
//             Contact an Advisor
//           </a>
//         </div>
