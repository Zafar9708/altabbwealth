...
const ConsultationForm = ({ isOpen, onClose, insight }) => {
  ...
  const handleSubmit = (e) => {
    ...
    console.log('Insight form submitted:', { ...formData, insight: insight?.title });
    alert(`Thank you for your interest in "${insight?.title}"! We will contact you soon with the full analysis.`);
    onClose();
    // Reset form
    setFormData({
      firstName: '',
      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h3 className="text-2xl font-bold text-[#14274E]">Access Full Analysis</h3>
            <button
              onClick={onClose}
          ...
          {insight && (
            <div className="mb-6 p-4 bg-[#FAF1E6] rounded-xl border border-[#8BC53F]/20">
              <h4 className="font-semibold text-[#14274E] mb-2">You're requesting:</h4>
              <p className="text-[#14274E]/80 text-sm">{insight.title}</p>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={handleInputChange}
                rows="3"
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:border-[#8BC53F] focus:ring-2 focus:ring-[#8BC53F]/20 transition-colors duration-300 resize-none"
...
const InsightsPage = () => {
  ...
  const handleReadAnalysis = (insight) => {
  ...
  return (
    <div className="min-h-screen bg-[#8BC53F]">
      ...
      <section className="relative pt-32 pb-28 bg-gradient-to-br from-[#14274E] via-[#1C315B] to-[#0A1A3A] overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-72 h-72 bg-[#8BC53F] rounded-full -translate-x-1/2 -translate-y-1/2"></div>
          <div className="absolute bottom-0 right-0 w-96 h-96 bg-[#8BC53F] rounded-full translate-x-1/3 translate-y-1/3"></div>
        </div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center mb-8">
              <div className="w-20 h-1 bg-[#8BC53F] mr-4"></div>
              <span className="text-[#8BC53F] font-bold text-sm uppercase tracking-widest bg-white/10 px-4 py-2 rounded-full backdrop-blur-sm">
                THOUGHT LEADERSHIP
              </span>
              <div className="w-20 h-1 bg-[#8BC53F] ml-4"></div>
            </div>
            
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white mb-8 leading-tight">
              Strategic <span className="text-[#8BC53F]">Clarity</span><br />
              in Complex Markets
            </h1>
      ...
      {featuredInsight && (
        <section className="relative -mt-20 pb-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="bg-white rounded-3xl shadow-2xl border border-[#8BC53F]/20 overflow-hidden transform hover:scale-[1.01] transition-all duration-500">
              <div className="grid grid-cols-1 lg:grid-cols-2">
                <div className="relative h-96 lg:h-auto">
                  ...
                  <div className="absolute top-6 left-6">
                    <span className="bg-[#8BC53F] text-white px-4 py-2 rounded-full text-sm font-bold uppercase tracking-widest">
                      Featured Analysis
                    </span>
                  </div>
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  <div className="flex items-center gap-4 mb-6">
                    <span className="bg-[#8BC53F] text-[#14274E] px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-12 h-12 bg-[#8BC53F] rounded-full flex items-center justify-center">
                    ...
                    <button 
                      onClick={() => handleReadAnalysis(featuredInsight)}
                      className="bg-[#8BC53F] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#14274E] transition-all duration-300 transform hover:scale-105"
                    >
                      Read Analysis
                    </button>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#14274E] mb-6">
              Latest <span className="text-[#8BC53F]">Insights</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white rounded-2xl p-6 shadow-xl border border-[#8BC53F]/10 sticky top-8">
                <div className="mb-8">
                  <h3 className="text-lg font-bold text-[#14274E] mb-4 flex items-center">
                    <svg className="w-5 h-5 mr-2 text-[#8BC53F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <button
                        ...
                        className={`w-full text-left px-4 py-3 rounded-xl font-semibold transition-all duration-300 flex items-center justify-between group ${
                          activeCategory === category 
                            ? 'bg-[#8BC53F] text-white shadow-lg' 
                            : 'bg-[#8BC53F] text-[#14274E] hover:bg-[#8BC53F]/10'
                        }`}
                      >
                        <span>{category}</span>
                        {activeCategory === category && (
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-4 py-3 pl-10 border-2 border-[#8BC53F]/20 rounded-xl focus:border-[#8BC53F] focus:ring-2 focus:ring-[#8BC53F]/20 transition-colors duration-300 bg-white"
                    />
                    <svg className="w-5 h-5 absolute left-3 top-3.5 text-[#8BC53F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z" />
                    </svg>
                  </div>
                </div>
              ...
              {filteredInsights.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-2 gap-8">
                  {filteredInsights.map((insight) => (
                    <div 
                      key={insight.id}
                      className="bg-white rounded-2xl shadow-lg border border-[#8BC53F]/10 hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 h-full flex flex-col group overflow-hidden"
                    >
                      <div className="relative overflow-hidden">
                        ...
                        <div className="absolute top-4 left-4">
                          <span className="bg-[#8BC53F] text-white px-3 py-1 rounded-full text-xs font-bold uppercase tracking-wider">
                            {insight.category}
                          </span>
                        </div>
                      ...
                      <div className="p-6 flex-1 flex flex-col">
                        <h3 className="text-xl font-bold text-[#14274E] mb-3 leading-tight flex-1 group-hover:text-[#8BC53F] transition-colors duration-300">
                          {insight.title}
                        </h3>
                        
                        <div className="mt-auto pt-4 border-t border-[#8BC53F]/10">
                          <div className="flex items-center justify-between">
                            <div className="flex items-center gap-3">
                            ...
                            <button 
                              onClick={() => handleReadAnalysis(insight)}
                              className="text-[#8BC53F] hover:text-[#14274E] transition-colors duration-300 p-2 rounded-lg hover:bg-[#FAF1E6]"
                            >
                ...
                <div className="text-center py-20 border-2 border-dashed border-[#8BC53F]/30 rounded-2xl bg-white/50 backdrop-blur-sm">
                  <svg className="w-16 h-16 text-[#8BC53F] mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-gradient-to-br from-[#14274E] via-[#1C315B] to-[#0A1A3A] relative overflow-hidden">
        <div className="absolute inset-0 opacity-5">
          <div className="absolute top-1/4 left-1/4 w-64 h-64 bg-[#8BC53F] rounded-full"></div>
          <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-[#8BC53F] rounded-full"></div>
        </div>
        
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Ready for <span className="text-[#8BC53F]">Personalized</span> Guidance?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button  onClick={() => handleReadAnalysis(featuredInsight)}
                  className="bg-[#8BC53F] text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-[#14274E] transition-all duration-300 transform hover:scale-105 shadow-2xl">
