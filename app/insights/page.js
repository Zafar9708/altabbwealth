    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black bg-opacity-50">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full max-h-[90vh] overflow-y-auto">
        <div className="p-6">
          ...
          {insight && (
            <div className="mb-6 p-4 bg-[#FAF1E6] rounded-xl border border-[#C6A04A]/20">
                ...
                <div className="p-8 lg:p-12 flex flex-col justify-center">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button 
                      ...
                      className="bg-[#C6A04A] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#14274E] transition-all duration-300 transform hover:scale-105"
                    >
                      Read Analysis
                    </button>
                  </div>
                        ...
                        <div className="mt-auto pt-4 border-t border-[#C6A04A]/10">
                          <div className="flex items-center justify-between">
                            ...
                            <button 
                              ...
                              className="text-[#C6A04A] hover:text-[#14274E] transition-colors duration-300 p-2 rounded-lg hover:bg-[#FAF1E6]"
                            >
                              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M14 5l7 7m0 0l-7 7m7-7H3" />
                              </svg>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button  onClick={() => handleReadAnalysis(featuredInsight)}
                  className="bg-[#C6A04A] text-white px-8 py-4 rounded-xl font-semibold hover:bg-white hover:text-[#14274E] transition-all duration-300 transform hover:scale-105 shadow-2xl">
              Schedule Consultation
            </button>
            <button  onClick={() => handleReadAnalysis(featuredInsight)}
