    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <div className="inline-flex items-center mb-6">
              ...
              <span className="text-[#8BC53F] font-semibold text-sm uppercase tracking-widest">
                CONTACT US
              </span>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-[#14274E] mb-6 leading-tight">
              Let's Streamline Your <span className="text-[#8BC53F]">Finances</span>
            </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    <div className="w-12 h-12 bg-[#C6A04A]/10 rounded-xl flex items-center justify-center mr-4 flex-shrink-0">
                      <svg className="w-6 h-6 text-[#8BC53F]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/>
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                      </svg>
                    </div>
                    <div>
                      <h3 className="font-semibold text-[] mb-1">Head Office</h3>
                ...
                {/* Quick Response */}
                <div className="mt-8 p-4 bg-[#8BC53F]/10 rounded-xl border border-[#C6A04A]/20">
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-[#8BC53F] rounded-full flex items-center justify-center mr-3 flex-shrink-0">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <button
                    type="submit"
                    disabled={isSubmitting}
                    className="w-full bg-[#8BC53F] text-white py-4 rounded-lg font-semibold hover:bg-[#14274E] transition-all duration-300 transform hover:scale-105 disabled:bg-gray-400 disabled:cursor-not-allowed disabled:transform-none flex items-center justify-center"
                  >
                    {isSubmitting ? (
                      <>
                        <svg className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#14274E] mb-6">
              Our <span className="text-[#8BC53F]">Global Reach</span>
            </h2>
      ...
      <section className="py-20 bg-brand-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-[#14274E] mb-6">
            Ready to Optimize Your <span className="text-white">Financial Operations</span>?
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              ...
              className="bg-[#8BC53F] text-white px-8 py-4 rounded-lg font-semibold  hover:text-[#14274E] transition-all duration-300 transform hover:scale-105"
            >
