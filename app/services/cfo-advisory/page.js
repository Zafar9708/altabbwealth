    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative pt-32 pb-28 bg-gradient-to-br from-[#14274E] via-[#1C315B] to-[#0A1A3A] overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-10 left-10 w-20 h-20 border-2 border-[#8BC53F] rotate-45"></div>
          <div className="absolute top-32 right-20 w-16 h-16 border-2 border-[#8BC53F] rotate-12"></div>
          <div className="absolute bottom-20 left-1/4 w-24 h-24 border-2 border-[#8BC53F] rotate-45"></div>
          <div className="absolute bottom-32 right-32 w-12 h-12 border-2 border-[#8BC53F]"></div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <div className="inline-flex items-center mb-6">
                <div className="w-12 h-1 bg-[#8BC53F] mr-4"></div>
                <span className="text-[#8BC53F] font-bold text-sm uppercase tracking-widest">
                  CFO ADVISORY SERVICES
                </span>
                <div className="w-12 h-1 bg-[#8BC53F] ml-4"></div>
              </div>
              
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
                Executive <span className="text-[#8BC53F]">Financial</span> Leadership
              </h1>
      ...
      {/* Services Showcase */}
      <section className="py-20 bg-[#8BC53F] relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-[#8BC53F]/5 rounded-full -translate-y-32 translate-x-32"></div>
        <div className="absolute bottom-0 left-0 w-80 h-80 bg-[#8BC53F]/5 rounded-full translate-y-40 -translate-x-40"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#14274E] mb-6">
              Comprehensive <span className="text-[#8BC53F]">CFO Advisory</span>
            </h2>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#14274E] mb-6">
              Our <span className="text-[#8BC53F]">Advisory Process</span>
            </h2>
          ...
          <div className="relative">
            {/* Timeline Line */}
            <div className="hidden lg:block absolute left-1/2 top-0 bottom-0 w-1 bg-gradient-to-b from-[#8BC53F] to-[#14274E] transform -translate-x-1/2"></div>
              ...
              {process.map((step, index) => (
                ...
                >
                  <div className={`lg:w-1/2 ${index % 2 === 0 ? 'lg:pr-12' : 'lg:pl-12'}`}>
                    <div className="bg-[#8BC53F] rounded-2xl p-8 border-l-4 border-[#8BC53F]">
                      <div className="text-4xl font-bold text-white mb-4">{step.step}</div>
                  ...
                  {/* Timeline Dot */}
                  <div className="hidden lg:flex absolute left-1/2 transform -translate-x-1/2 w-8 h-8 bg-[#8BC53F] rounded-full border-4 border-white shadow-lg z-10"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-white mb-6">
                <span className="text-[#8BC53F]">Strategic Impact</span> Delivered
              </h2>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-white/20">
                  ...
                  <span className="text-[#8BC53F] font-semibold">3-5x Investment</span>
                </div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-[#14274E] mb-6">
            Transform Your <span className="text-[#8BC53F]">Financial Leadership</span>
          </h2>
