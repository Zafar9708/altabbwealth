    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#14274E] to-[#0A1A3A]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="mb-8">
            <div className="w-20 h-1 bg-[#8BC53F] mx-auto mb-6"></div>
          ...
          <h1 className="text-5xl md:text-6xl font-light text-white mb-8 leading-tight">
            Strategic <span className="font-bold text-[#8BC53F]">Financial Intelligence</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button 
              ...
              className="bg-[#8BC53F] text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-[#14274E] transition-all duration-300"
            >
            ...
            {services.map((service, index) => (
              ...
              >
                <div className="lg:w-1/2">
                  <div className="bg-white rounded-2xl p-8 shadow-lg border border-[#8BC53F]/10">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      {service.features.map((feature, featureIndex) => (
                        <div key={featureIndex} className="flex items-center">
                          <div className="w-1.5 h-1.5 bg-[#8BC53F] rounded-full mr-3"></div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            {/* Vertical Line */}
            <div className="absolute left-8 top-0 bottom-0 w-0.5 bg-[#8BC53F]/20"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-white mb-6">
                <span className="text-[#8BC53F]">45% Improvement</span> in Forecasting Accuracy
              </h2>
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between py-3 border-b border-white/20">
                  ...
                  <span className="text-[#8BC53F] font-semibold">4-8 Weeks</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-white/20">
                  <span className="text-white/80">Forecast Accuracy Goal</span>
                  <span className="text-[#8BC53F] font-semibold">85%+</span>
                </div>
                <div className="flex items-center justify-between py-3">
                  <span className="text-white/80">ROI Achievement</span>
                  <span className="text-[#8BC53F] font-semibold">3-6 Months</span>
                </div>
              </div>
              <button 
                onClick={() => setShowConsultationForm(true)}
      ...
      <section className="py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-light text-[#14274E] mb-6">
            Transform Your <span className="font-bold text-[#8BC53F]">Financial Planning</span>
          </h2>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button 
              onClick={() => setShowConsultationForm(true)}
              className="bg-[#8BC53F] text-white px-8 py-4 rounded-lg font-semibold hover:bg-[#14274E] transition-all duration-300"
            >
              Schedule Consultation
            </button>
            <button 
