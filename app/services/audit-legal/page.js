    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-[#14274E] to-[#0A1A3A]">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-white mb-6 leading-tight">
            Complete <span className="text-[#8BC53F]">Audit & Legal</span> Framework
          </h1>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-[#14274E] mb-6">
              Comprehensive <span className="text-white">Audit & Legal Services</span>
            </h2>
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-[#14274E] mb-6">
              Our <span className="text-[#8BC53F]">Audit Process</span>
            </h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-white mb-6">
              <span className="text-[#8BC53F]">Proven Results</span> in Audit & Legal
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {caseStudies.map((study, index) => (
              ...
              >
                ...
                <div className="text-[#8BC53F] font-bold text-lg mb-4">{study.result}</div>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-[#14274E] mb-6">
                <span className="text-[#8BC53F]">Comprehensive Risk Mitigation</span> Framework
              </h2>
            ...
            <div className="bg-[#8BC53F] rounded-2xl p-8 border border-[#8BC53F]/20">
              <h3 className="text-2xl font-bold text-[#14274E] mb-6">Audit Readiness Assessment</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between py-3 border-b border-[#8BC53F]/20">
                ...
                <div className="flex items-center justify-between py-3 border-b border-[#8BC53F]/20">
                  ...
                  <span className="text-[#8BC53F] font-semibold">100% Target</span>
                </div>
                <div className="flex items-center justify-between py-3 border-b border-[#8BC53F]/20">
                  <span className="text-[#14274E]">Risk Reduction</span>
                  <span className="text-[#8BC53F] font-semibold">40% Average</span>
                </div>
              ...
              <button 
                onClick={() => setShowAssessmentForm(true)}
                className="w-full bg-[#14274E] text-white py-4 rounded-xl font-semibold hover:bg-[#14274E] transition-all duration-300 mt-6"
              >
                Start Assessment
              </button>
            </div>
      ...
      <section className="py-20 bg-gradient-to-br from-[#14274E] to-[#1C315B]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ensure Complete <span className="text-[#8BC53F]">Compliance & Protection</span>
          </h2>
